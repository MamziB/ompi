...
inline int ompi_osc_ucx_dynamic_lock(ompi_osc_ucx_module_t *module, int target) {
...
inline int ompi_osc_ucx_dynamic_unlock(ompi_osc_ucx_module_t *module, int target) {
    uint64_t result_value = -1;
    uint64_t remote_addr = (module->state_addrs)[target] + OSC_UCX_STATE_DYNAMIC_LOCK_OFFSET;
    ucp_ep_h *ep;
    OSC_UCX_GET_DEFAULT_EP(ep, module, target);
...
inline int ompi_osc_ucx_acc_unlock(ompi_osc_ucx_module_t *module, int target,
